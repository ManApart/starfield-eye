val exampleMockResponseData = """
    bat starfield-eye-poll
    Command: bat starfield-eye-poll
    > ;For use with https://manapart.github.io/starfield-eye/#galaxy
    > ;Commented out stat gets are ones that I don't have the right name for yet
    > ;Get quests
    > sqo
    == One Small Step ==
    ( Instance: 1 )
    ...
    == Wrapper for NeonZ07 ==
    ( Instance: 1 )
    100 Talk to Saburo Okadigbo COMPLETED
    ...
    50 (Optional) Talk to your Friends before you Leave COMPLETED
    ...
    5 Use the Eye to Locate Temples COMPLETED
    3 Talk to Vladimir to Locate Temples COMPLETED
    10 Acquire the Power on Marduk IV COMPLETED
    7 Obtain a Ship with a 28LY Grav Jump Range COMPLETED
    ...
    == One Giant Leap ==
    ( Instance: 1 )
    40 Complete the Armillary COMPLETED
    60 Power Up the Grav Drive to Jump to the Unity DORMANT
    70 Remove the Armillary to Grav Jump Normally DORMANT
     
    == Saburo's Solution ==
    ( Instance: 1 )
    10 Distribute Flyers to Neon Merchants ( 5 / 5) COMPLETED
     
    == Hard Luck ==
    ( Instance: 1 )
    10 Convince Saburo to take the loan COMPLETED
    20 (Optional) Find Clover's Diary COMPLETED
    5 (Optional) Read Clover's Diary COMPLETED
    30 (Optional) Tell Saburo about Clover's feelings COMPLETED
     
    == Saburo's Solution ==
    ( Instance: 1 )
    120 Return to Saburo COMPLETED
     
    == Hard Luck ==
    ( Instance: 1 )
    70 Return to Clover COMPLETED
     
    ==  ==
    ( Instance: 0 )
    30 Visit your Sky Suite in the Neon Trade Tower COMPLETED
    ...
    Player misc stat value 213.00
    > getpcmiscstat "locations explored"
    Player misc stat value 211.00
    > getpcmiscstat "days passed"
    Player misc stat value 64.00
    > getpcmiscstat "hours slept"
    Player misc stat value 71.00
    > ;getpcmiscstat "hours waited"
    > getpcmiscstat "credits found"
    Player misc stat value 2053327.00
    > getpcmiscstat "most credits carried"
    Player misc stat value 753491.00
    > ;getpcmiscstat "containers looted"
    > getpcmiscstat "magazines found"
    Player misc stat value 27.00
    > getpcmiscstat "persuasion successes"
    Invalid misc stat 'persuasion successes' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "afflictions suffered"
    Player misc stat value 27.00
    > getpcmiscstat "food eaten"
    Player misc stat value 88.00
    > getpcmiscstat "data slates read"
    Player misc stat value 152.00
    > getpcmiscstat "skill challenges completed"
    Invalid misc stat 'skill challenges completed' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "snow globes collected"
    Player misc stat value 4.00
    > ;Exploration
    > getpcmiscstat "systems visited"
    Player misc stat value 57.00
    > getpcmiscstat "planets scanned"
    Player misc stat value 441.00
    > getpcmiscstat "planets fully surveyed"
    Player misc stat value 74.00
    > getpcmiscstat "planets landed on"
    Player misc stat value 78.00
    > getpcmiscstat "flora fully scanned"
    Player misc stat value 19.00
    > getpcmiscstat "fauna fully scanned"
    Player misc stat value 16.00
    > getpcmiscstat "stations docked with"
    Player misc stat value 42.00
    > getpcmiscstat "ships docked with"
    Player misc stat value 47.00
    > getpcmiscstat "unique creatures scanned"
    Player misc stat value 54.00
    > getpcmiscstat "temples found"
    Player misc stat value 21.00
    > ;Ship
    > getpcmiscstat "grav jumps"
    Player misc stat value 125.00
    > getpcmiscstat "farthest grav jump"
    Player misc stat value 34.00
    > getpcmiscstat "ships registered"
    Invalid misc stat 'ships registered' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "max ships owned"
    Player misc stat value 6.00
    > getpcmiscstat "most expensive ship owned"
    Player misc stat value 398375.00
    > getpcmiscstat "largest ship owned"
    Player misc stat value 1950.00
    > getpcmiscstat "largest crew size"
    Player misc stat value 5.00
    > getpcmiscstat "ships customized"
    Player misc stat value 5.00
    > getpcmiscstat "ship builder credits spent"
    Player misc stat value 1138275.00
    > getpcmiscstat "ships sold"
    Player misc stat value 1.00
    > getpcmiscstat "ships painted"
    Player misc stat value 4.00
    > getpcmiscstat "ship modules built"
    Player misc stat value 168.00
    > ;Mission
    > getpcmiscstat "quests completed"
    Player misc stat value 119.00
    > getpcmiscstat "activities completed"
    Player misc stat value 101.00
    > getpcmiscstat "main quests completed"
    Player misc stat value 18.00
    > getpcmiscstat "crimson fleet collective quests completed"
    Invalid misc stat 'crimson fleet collective quests completed' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "freestar collective quests completed"
    Player misc stat value 9.00
    > getpcmiscstat "ryujin industries quests completed"
    Player misc stat value 13.00
    > getpcmiscstat "united colonies quests completed"
    Player misc stat value 11.00
    > getpcmiscstat "side quests completed"
    Player misc stat value 101.00
    > ;Combat
    > getpcmiscstat "people killed"
    Player misc stat value 668.00
    > getpcmiscstat "creatures killed"
    Player misc stat value 300.00
    > getpcmiscstat "robots killed"
    Player misc stat value 55.00
    > getpcmiscstat "turrets killed"
    Player misc stat value 42.00
    > getpcmiscstat "elite enemies killed"
    Invalid misc stat 'elite enemies killed' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "critical strikes"
    Player misc stat value 1402.00
    > getpcmiscstat "sneak attacks"
    Player misc stat value 64.00
    > getpcmiscstat "boost packs exploded"
    Invalid misc stat 'boost packs exploded' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "zero g kills"
    Player misc stat value 23.00
    > getpcmiscstat "powers used"
    Player misc stat value 389.00
    > getpcmiscstat "scoped kills"
    Player misc stat value 519.00
    > getpcmiscstat "max damage shot"
    Player misc stat value 299.00
    > getpcmiscstat "melee kills"
    Player misc stat value 39.00
    > getpcmiscstat "laser kills"
    Player misc stat value 258.00
    > getpcmiscstat "ballistic kills"
    Player misc stat value 564.00
    > getpcmiscstat "head shots"
    Player misc stat value 2616.00
    > getpcmiscstat "explosive kills"
    Player misc stat value 27.00
    > getpcmiscstat "starborn killed"
    Player misc stat value 41.00
    > getpcmiscstat "ships destroyed"
    Player misc stat value 127.00
    > getpcmiscstat "favorite weapon"
    Player misc stat value 2585544.00
    > getpcmiscstat "favorite power"
    Player misc stat value 2904977.00
    > ;Crafting
    > getpcmiscstat "weapon mods crafted"
    Invalid misc stat 'weapon mods crafted' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "armor mods crafted"
    Invalid misc stat 'armor mods crafted' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "organic resources gathered"
    Player misc stat value 87.00
    > getpcmiscstat "inorganic resources gathered"
    Player misc stat value 399.00
    > getpcmiscstat "chems crafted"
    Invalid misc stat 'chems crafted' for parameter Miscellaneous Stat.
    Compiled script not saved!
    > getpcmiscstat "food cooked"
    Player misc stat value 3.00
    > getpcmiscstat "outposts built"
    Player misc stat value 11.00
    > getpcmiscstat "objects built"
    Player misc stat value 180.00
    > getpcmiscstat "cargo links established"
    Player misc stat value 8.00
    > ;Crime
    > getpcmiscstat "locks picked"
    Player misc stat value 150.00
    > getpcmiscstat "pockets picked"
    Player misc stat value 0.00
    > getpcmiscstat "items stolen"
    Player misc stat value 39.00
    > getpcmiscstat "assaults"
    Player misc stat value 1.00
    > getpcmiscstat "murders"
    Player misc stat value 1.00
    > getpcmiscstat "trespasses"
    Player misc stat value 0.00
    > getpcmiscstat "times arrested"
    Player misc stat value 1.00
    > getpcmiscstat "most contraband carried"
    Player misc stat value 28.00
    > getpcmiscstat "times caught with contraband"
    Player misc stat value 0.00
    > getpcmiscstat "acts of piracy"
    Player misc stat value 0.00
    > getpcmiscstat "total lifetime bounty"
    Player misc stat value 1500.00
    > getpcmiscstat "largest bounty"
    Player misc stat value 650.00
""".trimIndent()